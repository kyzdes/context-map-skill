...
| XL | Multiple repos, platform, SDKs, or environments | root index + `architecture.md` + `domains/*.md` |
...
Use XL when one context map would become a platform encyclopedia. The root map should route to domain maps under `domains/`.
